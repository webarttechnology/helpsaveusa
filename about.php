<?php include("header.php") ?>
    <section class="banner mb-5 innerBanner" style="background:url(images/about/banner.webp) no-repeat top left; background-size:cover;">
    ...
    <section class="pt-5 pb-5 about">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-11">
                    <h3 class="shadowtext text-center">Our Story</h3>
                </div>
                <div class="col-xxl-5 col-xl-5 move-top">
                    <img src="images/about/2.webp" alt="map" loading="lazy" class="img-fluid" />
                    <p>The National Martial Arts League (NMAL) was established as a visionary platform to promote discipline, respect, and community engagement through martial arts. Founded by Dexter V. Kennedy, the league has grown from a bold idea into a powerful movement aimed at transforming lives through sportsmanship and personal development.</p>
                    <p>Together, Help S.A.V.E. USA and the National Martial Arts League have united their missions to form a groundbreaking partnership in the fight against violence across America.</p>
                </div>
                <div class="col-xxl-5 col-xl-5">
                    <h2>The History of Help S.A.V.E. USA & <span class="text-primary">The National Martial Arts League</span></h2>
