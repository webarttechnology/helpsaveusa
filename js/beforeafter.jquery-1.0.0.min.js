    ...
    return this.each(function () {
      !(function (t) {
        if (2 == jQuery(t).children().length) {
          ...
          Q.setAttribute(
            "style",
            "border:solid black;border-width:0 2px 2px 0;display:inline-block;padding:6px;transform:rotate(135deg);-webkit-transform:rotate(135deg);"
          );
          var g = document.createElement("I");
          g.setAttribute(
            "style",
            "border:solid black;border-width:2px 0 0 2px;display:inline-block;padding:6px;transform:rotate(135deg);-webkit-transform:rotate(135deg);"
          );
          var w = document.createElement("DIV");
          w.setAttribute(
            "style",
            "position:absolute;width:61px;height:61px;line-height:65px;padding:.0 8px;text-align:center;top:50%;left:50%;transform:translate(-50%,-50%);border-radius:50%;background-color:#fff;"
          );
